...
console.log(black); // Output: "horse"
console.log(pink); // Output: "pig"


// String: uses destructuring to declare the three traditional animal colors
const [, , sheepColor] = farmAnimals.split(' ');

// Now, 'sheepColor' will correctly contain the value 'sheep'
console.log(sheepColor); // Output: "sheep"
